 ...
 */
    ...
    (() => {
        ...
        function initSliders() {
            if (document.querySelector(".swiper-home")) new core(".swiper-home", {
            ...
            if (document.querySelector(".swiper-license")) new core(".swiper-license", {
                modules: [ Navigation, Pagination ],
                observer: true,
                observeParents: true,
                slidesPerView: 4,
...
***************************************************************************** */
        ...
        if ("undefined" != typeof map && null != map) {
            let map = L.map("map", {
                zoomControl: false
            }).setView([ 55.722537, 49.171506 ], 15);
            let myIcon = L.icon({
            ...
            L.marker([ 55.722537, 49.171506 ], {
                icon: myIcon
            }).addTo(map).bindPopup("г. Казань, ул. Гареева, д. 92, оф. 8");
        }
        const headerMenu = document.querySelector(".menu-js");
        if ("undefined" != typeof headerMenu && null != headerMenu) headerMenu.onclick = function() {
